...
//import mojo.security.Encryptor;
import java.sql.*;
...
public class SecureDirectory implements IDirectory
{
	private static IDirectory _secureDir;			// singleton instance of SimpleDirectory
  ...
  * @throws IOException This exception is thrown if the properties file is corrupt.
	*/
	...
	{
		String filename = "../pooluser.properties";			// name and directory of the prop file
	...
	*/
		...
		throws OculusException
	{
		...
		if (_secureDir == null)
		{
			...
			{
				// get a new one
				_secureDir = new SecureDirectory();
			}
			catch (Exception exp)
			{
  ...
  */
    ...
    try
    {
  		retVal = null; // Encryptor.decrypt((String)_dir.getObject(Encryptor.encrypt("obj."+directory+"."+property)));
    }
