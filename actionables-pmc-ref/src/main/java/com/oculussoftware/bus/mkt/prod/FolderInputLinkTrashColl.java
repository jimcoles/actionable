...
public class FolderInputLinkTrashColl extends FolderInputLinkMarketInputColl implements IFolderInputLinkColl

{
  ...
  public FolderInputLinkTrashColl() throws OculusException
  {
    super();
  }

  protected FolderInputLinkTrashColl(Comparator sortCrit) throws OculusException
  {
    super (sortCrit);
  }
    ...
    throws ORIOException
  {
    return " SELECT * "+
           " FROM "+TABLE+           
           " WHERE MARKETINPUTID="+getIID()+" AND DELETESTATE=0";
...
//------------------- IBusinessObjectList Methods --------------------------
  public IRCollection setSort(Comparator sortCrit)
    throws OculusException
  {
    FolderInputLinkTrashColl sortedList = new FolderInputLinkTrashColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
      FolderInputLinkTrashColl catList = null;
      catList = new FolderInputLinkTrashColl();
      catList.setIID(_iid);
