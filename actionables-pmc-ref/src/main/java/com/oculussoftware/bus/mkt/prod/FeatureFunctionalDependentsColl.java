...
public class FeatureFunctionalDependentsColl extends FeatureColl implements IFeatureColl, IPersistable
{
  ...
  protected String COL_DELETESTATE = "DELETESTATE";
	...
	public FeatureFunctionalDependentsColl() throws OculusException
	{
    super();
    COL_OBJECTID = "LINK_OBJECTID";
	}

  protected FeatureFunctionalDependentsColl(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
      COL_OBJECTID = "LINK_OBJECTID";
}
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  {
    FeatureFunctionalDependentsColl sortedList = new FeatureFunctionalDependentsColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
	...
	{
		FeatureFunctionalDependentsColl verList = null;
			verList = new FeatureFunctionalDependentsColl();
			verList.setIID(_iid);
