...
public class AllFolderColl extends BusinessObjectColl implements IFolderColl

{
  ...
  public AllFolderColl() throws OculusException
  {
    super();
  }

  protected AllFolderColl(Comparator sortCrit) throws OculusException
  {
    super (sortCrit);
  }
  ...
  {
    return " SELECT * FROM FOLDER WHERE DELETESTATE=1";           
  }
...
//------------------- IBusinessObjectList Methods --------------------------
  public IRCollection setSort(Comparator sortCrit)
    throws OculusException
  {
    AllFolderColl sortedList = new AllFolderColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
    AllFolderColl catList = null;
      catList = new AllFolderColl();
      catList.setIID(_iid);
