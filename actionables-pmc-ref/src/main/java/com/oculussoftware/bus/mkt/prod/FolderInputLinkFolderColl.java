...
public class FolderInputLinkFolderColl extends BusinessObjectColl implements IFolderInputLinkColl

{
  ...
  public FolderInputLinkFolderColl() throws OculusException
  {
    super();
  }

  protected FolderInputLinkFolderColl(Comparator sortCrit) throws OculusException
  {
    super (sortCrit);
  }
    ...
    throws ORIOException
  {
    return " SELECT * "+
           " FROM "+TABLE+           
           " WHERE FOLDERID="+getIID().getLongValue()+" AND DELETESTATE=1";
...
//------------------- IBusinessObjectList Methods --------------------------
  public IRCollection setSort(Comparator sortCrit)
    throws OculusException
  {
    FolderInputLinkFolderColl sortedList = new FolderInputLinkFolderColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
    FolderInputLinkFolderColl catList = null;
      catList = new FolderInputLinkFolderColl();
      catList.setIID(_iid);
