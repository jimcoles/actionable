...
public class FolderInputLinkColl extends BusinessObjectColl implements IFolderInputLinkColl

{
  ...
  public FolderInputLinkColl() throws OculusException
  {
    super();
  }

  protected FolderInputLinkColl(Comparator sortCrit) throws OculusException
  {
    super (sortCrit);
  }
...
//------------------- IBusinessObjectList Methods --------------------------
  public IRCollection setSort(Comparator sortCrit)
    throws OculusException
  {
    FolderInputLinkColl sortedList = new FolderInputLinkColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
    FolderInputLinkColl catList = null;
      catList = new FolderInputLinkColl();
      catList.setIID(_iid);
