...
public class FeatureFileList extends FileList
{
	//----------------------------- Public Constructor -------------------------
	/** Default constructor just initializes the product list */
	public FeatureFileList() throws OculusException
	{
    super();
	}
  ...
  /** Default constructor just initializes the product list */
  protected FeatureFileList(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
  }
    ...
    throws ORIOException
  {
    return " SELECT ATT."+COL_OBJECTID+ ", ATT.NAME, ATT.FILESIZEBYTES, ATT.CREATIONDATE, ATT.INCLUDEINDOCRPTS, APP.LASTNAME, APP.FIRSTNAME " +
           ...
           " WHERE ATT."+COL_TYPE+"=1 AND CAT.FEATUREID="+getIID().getLongValue()+
           ...
           " WHERE ATTT."+COL_TYPE+"=1 AND STD.FEATUREID="+getIID().getLongValue()+
           " ORDER BY "+_sortby;
  }
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  {
    FeatureFileList sortedList = new FeatureFileList(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
    FeatureFileList fileList = null;
      fileList = new FeatureFileList();
