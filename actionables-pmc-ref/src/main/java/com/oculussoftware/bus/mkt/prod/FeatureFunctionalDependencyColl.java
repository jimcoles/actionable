...
public class FeatureFunctionalDependencyColl extends FeatureColl implements IFeatureColl, IPersistable
{
  ...
  protected String COL_DELETESTATE = "DELETESTATE";
	...
	public FeatureFunctionalDependencyColl() throws OculusException
	{
    super();
    COL_OBJECTID = "LINK_OBJECTID";
	}

  protected FeatureFunctionalDependencyColl(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
    COL_OBJECTID = "LINK_OBJECTID";
  }
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  {
    FeatureFunctionalDependencyColl sortedList = new FeatureFunctionalDependencyColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
	...
	{
		FeatureFunctionalDependencyColl verList = null;
			verList = new FeatureFunctionalDependencyColl();
			verList.setIID(_iid);
