...
public class FeatureWorkflowDependencyColl extends FeatureColl implements IFeatureColl, IPersistable
{
  ...
  protected String COL_DELETESTATE = "DELETESTATE";
	...
	public FeatureWorkflowDependencyColl() throws OculusException
	{
    super();
    COL_OBJECTID = "LINK_OBJECTID";
	}

  protected FeatureWorkflowDependencyColl(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
    COL_OBJECTID = "LINK_OBJECTID";
  }
  ...
  return " SELECT  feat.OBJECTID AS FEAT_OBJECTID, feat.GUID AS FEAT_GUID, feat.CLASSID AS FEAT_CLASSID, feat.STATEID AS FEAT_STATEID, "+
         ...
         "    LEFT OUTER JOIN SEMANTICLINK sl ON link.OBJECTID=sl.SRCOBJECTID "+
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  {
    FeatureWorkflowDependencyColl sortedList = new FeatureWorkflowDependencyColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
	...
	{
		FeatureWorkflowDependencyColl verList = null;
			verList = new FeatureWorkflowDependencyColl();
			verList.setIID(_iid);
