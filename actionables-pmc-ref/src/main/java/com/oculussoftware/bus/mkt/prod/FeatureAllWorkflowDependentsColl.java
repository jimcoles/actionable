...
public class FeatureAllWorkflowDependentsColl extends FeatureColl implements IFeatureColl, IPersistable
{
  ...
  protected String COL_DELETESTATE = "DELETESTATE";
	...
	public FeatureAllWorkflowDependentsColl() throws OculusException
	{
    super();
    COL_OBJECTID = "LINK_OBJECTID";
	}

  protected FeatureAllWorkflowDependentsColl(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
    COL_OBJECTID = "LINK_OBJECTID";
  }
  ...
  return " SELECT  feat.OBJECTID AS FEAT_OBJECTID, feat.GUID AS FEAT_GUID, feat.CLASSID AS FEAT_CLASSID, feat.STATEID AS FEAT_STATEID, "+
         ...
         " WHERE sl.SRCOBJECTID="+getIID().getLongValue()+
           "  AND sl.LINKTYPE="+LinkKind.WORKFLOW_DEP.getIntValue()+
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  {
    FeatureAllWorkflowDependentsColl sortedList = new FeatureAllWorkflowDependentsColl(sortCrit);
  ...
  */
    ...
    throws OculusException
  {
    ...
    IFeatureColl deps = link.getWorkflowDependents();
...
//----------------- IPoolable Methods ------------------------------------
	...
	{
		FeatureAllWorkflowDependentsColl verList = null;
			verList = new FeatureAllWorkflowDependentsColl();
			verList.setIID(_iid);
