...
public class MarketInputFolderList extends BusinessObjectList implements IBusinessObjectList
{
  
  public MarketInputFolderList() throws OculusException
  {
    super();
  }

  protected MarketInputFolderList(Comparator sortCrit) throws OculusException
  {
    super (sortCrit);
  }
  ...
  {
    MarketInputFolderList sortedList = new MarketInputFolderList(sortCrit);
...
//      CRM.getInstance().returnDatabaseConnection(repConn);
  ...
  {
    MarketInputFolderList featList = null;
      featList = new MarketInputFolderList();
