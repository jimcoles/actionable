...
public class FeatureWorkflowDependentsColl extends FeatureColl implements IFeatureColl, IPersistable
{
  ...
  protected String COL_DELETESTATE = "DELETESTATE";
	...
	public FeatureWorkflowDependentsColl() throws OculusException
	{
    super();
    COL_OBJECTID = "LINK_OBJECTID";
	}

  protected FeatureWorkflowDependentsColl(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
    COL_OBJECTID = "LINK_OBJECTID";
  }
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  {
    FeatureWorkflowDependentsColl sortedList = new FeatureWorkflowDependentsColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
	...
	{
		FeatureWorkflowDependentsColl verList = null;
			verList = new FeatureWorkflowDependentsColl();
			verList.setIID(_iid);
