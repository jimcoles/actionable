...
public class GlobalProductVersionColl extends BusinessObjectColl implements IProductVersionColl, IPersistable
{
  ...
  public GlobalProductVersionColl() throws OculusException
  {
    super();
  }

  protected GlobalProductVersionColl(Comparator sortCrit) throws OculusException
  {
    super(sortCrit);
  }
...
//------------------- IBusinessObjectList Methods --------------------------
  public IRCollection setSort(Comparator sortCrit)
    throws OculusException
  {
    GlobalProductVersionColl sortedList = new GlobalProductVersionColl(sortCrit);
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
    GlobalProductVersionColl verList = null;
      verList = new GlobalProductVersionColl();
      verList.setIID(_iid);
