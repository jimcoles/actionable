...
public class MarketInputFeatureColl extends MarketInputColl implements IMarketInputColl
{
  
  public MarketInputFeatureColl() throws OculusException
  {
    super();
  }
  ...
  {
    MarketInputFeatureColl featList = null;
      featList = new MarketInputFeatureColl();
