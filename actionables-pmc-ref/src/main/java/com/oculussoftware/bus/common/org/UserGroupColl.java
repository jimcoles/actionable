...
public class UserGroupColl extends BusinessObjectColl implements IUserColl, IPersistable
{
  ...
  public UserGroupColl() throws OculusException
  {
	 super();
	 TABLE = "USERGROUPASC";
  }  
  protected UserGroupColl (Comparator sortCrit) throws OculusException
  {
	super(sortCrit);
  }  
...
{
	UserGroupColl usrColl = null;
	usrColl = new UserGroupColl();
	usrColl.setIID(_iid);
 ...
 //------------------- IBusinessObjectColl Methods --------------------------
  ...
  {
	UserGroupColl sortedList = new UserGroupColl(sortCrit);
