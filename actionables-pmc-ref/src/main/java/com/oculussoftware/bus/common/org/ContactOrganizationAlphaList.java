...
*	BUG00326				Zain Nemazie		5/24/00			Making delete a soft delete, so now query must check deletestate
*/

public class ContactOrganizationAlphaList extends com.oculussoftware.bus.BusinessObjectList implements  IPersistable, IOrganizationList
{
  ...
  public ContactOrganizationAlphaList() throws OculusException
  {
  super();
  TABLE = "ORGANIZATION";
    _sortby = "";
...
/** Default constructor just initializes the list */
protected ContactOrganizationAlphaList(Comparator sortCrit) throws OculusException
{
  super(sortCrit);
}
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
  ContactOrganizationAlphaList catList = null;
    catList = new ContactOrganizationAlphaList();
    catList.setIID(_iid);
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  throws OculusException
  {
  ContactOrganizationAlphaList sortedList = new ContactOrganizationAlphaList(sortCrit);
