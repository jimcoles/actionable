...
public class UserContactAllAlphaList extends com.oculussoftware.bus.BusinessObjectList implements  IPersistable, IUserList
{
	...
	public UserContactAllAlphaList() throws OculusException
	{
	super();
	TABLE = "APPUSER";
	}
...
/** Default constructor just initializes the list */
protected UserContactAllAlphaList(Comparator sortCrit) throws OculusException
{
	super(sortCrit);
}
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
	UserContactAllAlphaList catList = null;
	  catList = new UserContactAllAlphaList();
	  catList.setIID(_iid);
...
protected String getLoadQuery() throws ORIOException
{
	return "SELECT OBJECTID " + 
        " FROM " + TABLE + 
        " WHERE " + COL_LASTNAME+" like '"+ _sortbyLastName +"%' AND " + COL_FIRSTNAME+" like '"+ _sortbyFirstName +"%'  AND DELETESTATE <> " + DeleteState.DELETED.getIntValue() + 
...
//------------------- IBusinessObjectList Methods --------------------------
  public IRCollection setSort(Comparator sortCrit)
	throws OculusException
  {
	UserContactAllAlphaList sortedList = new UserContactAllAlphaList(sortCrit);
