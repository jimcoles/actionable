...
public class GroupList extends BusinessObjectList implements IGroupList
{
  ...
  public GroupList() throws OculusException
  {
   super();
   TABLE = "USERGROUP";
  }

  protected GroupList (Comparator sortCrit) throws OculusException
  {
  super(sortCrit);
  }
...
{
  GroupList grpColl = null;
  grpColl = new GroupList();
  grpColl.setIID(_iid);
 ...
 //------------------- IBusinessObjectColl Methods --------------------------
  ...
  {
  GroupList sortedList = new GroupList(sortCrit);
