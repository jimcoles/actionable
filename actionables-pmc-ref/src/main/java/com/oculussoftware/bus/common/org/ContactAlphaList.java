...
public class ContactAlphaList extends com.oculussoftware.bus.BusinessObjectList implements  IPersistable, IUserList
{
  ...
  public ContactAlphaList() throws OculusException
  {
  super();
  TABLE = "APPUSER";
  }
...
/** Default constructor just initializes the list */
protected ContactAlphaList(Comparator sortCrit) throws OculusException
{
  super(sortCrit);
}
...
//----------------- IPoolable Methods ------------------------------------
  ...
  {
  ContactAlphaList catList = null;
    catList = new ContactAlphaList();
    catList.setIID(_iid);
...
protected String getLoadQuery() throws ORIOException
{
  ...
  "AND ISINTERNAL=0 ORDER BY LOWER(" + COL_LASTNAME+"), LOWER("+COL_FIRSTNAME+")";
...
//------------------- IBusinessObjectList Methods --------------------------
  ...
  throws OculusException
  {
  ContactAlphaList sortedList = new ContactAlphaList(sortCrit);
